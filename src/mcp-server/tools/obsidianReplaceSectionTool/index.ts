/**
 * @fileoverview Barrel file for the 'obsidian_replace_section' MCP tool.
 *
 * This file serves as the public entry point for the obsidian_replace_section tool module.
 * It re-exports the primary registration function (`registerObsidianReplaceSectionTool`)
 ...
 */
export { registerObsidianReplaceSectionTool } from "./registration.js";
